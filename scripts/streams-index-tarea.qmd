...
chem_1819 <- readr::read_csv("../streams-rivers-2018-2019/nrsa_1819_water_chemistry_chla_-_data.csv")
pchl_1819 <- readr::read_csv("../streams-rivers-2018-2019/NRSA_1819_PeriChla.csv")
pbio_1819 <- readr::read_csv("../streams-rivers-2018-2019/NRSA_1819_pbio_0.csv")
inv_1819  <- readr::read_csv("../streams-rivers-2018-2019/nrsa_1819_benthic_macroinvertebrate_count_-_data.csv")
fish_1819 <- readr::read_csv("../streams-rivers-2018-2019/nrsa-1819-fish-count-data.csv")

# 2023-2024 (validacion externa)
chem_2324 <- readr::read_csv("../streams-rivers-2023-2024/nrsa2324_waterchemistry.csv")
pchl_2324 <- readr::read_csv("../streams-rivers-2023-2024/nrsa2324_periphytonchlorophyll-a.csv")
pbio_2324 <- readr::read_csv("../streams-rivers-2023-2024/nrsa2324_periphytonbiomass.csv")
inv_2324  <- readr::read_csv("../streams-rivers-2023-2024/nrsa2324_benthiccount.csv")
fish_2324 <- readr::read_csv("../streams-rivers-2023-2024/nrsa2324_fishcount.csv")
```
...
train_base <- tp_1819 |>
  dplyr::left_join(pchl_train, by = c("uid", "site", "visit")) |>
