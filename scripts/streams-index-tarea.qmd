...
# Gráfico correlaión
ggplot(train_base, aes(x = log10(chla_peri), y = log10(bio_peri))) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE, color = "blue") +
  labs(
    title = "Correlación entre Chl-a y Biomasa de Perifiton",
    x = expression("log10(Chl-a)"),
    y = expression("log10(Biomasa)")
  ) +
  theme_classic()
# Preguntas:
...
graf_m3<-ggplot(test_m3,aes(x = logtp, y = pred_logtp_m3)) +
  ...
  geom_smooth(method = "lm", se = FALSE, color = "blue") +
  labs(
    title = "Valores observados vs predichos del modelo 3",
    x = expression("TP observado ("*log[10]*")"),
    y = expression("TP predicho ("*log[10]*")")
  ) +
  theme_classic()
